...
module pulser_general_reg_top #(
  ...
  // To HW
  output pulser_general_reg_pkg::pulser_general_reg2hw_t reg2hw, // Write
  ...
  assign ctrl_start_wd = reg_wdata[15:0];
